...
func main() {
	...
	v1Router.Post("/feed-follows", apiCnfg.middlewareAuth(apiCnfg.handlerCreateFeedFollow))
	v1Router.Get("/feeds-follows", apiCnfg.middlewareAuth(apiCnfg.handlerGetFeedFollows))
